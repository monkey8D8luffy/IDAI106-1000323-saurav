...
css = “””
/* ── GOOGLE FONTS ── */
@import url(‘https://fonts.googleapis.com/css2?family=DM+Sans:ital,opsz,wght@0,9..40,200;0,9..40,300;0,9..40,400;0,9..40,500;1,9..40,300&family=Syne:wght@300;400;500;600;700&display=swap’);
...
with col:
    ...
    if audio_choice == "FutureForward Originals":
        # Royalty-free placeholder audio (public-domain binaural tone URL)
        ...
        # Spotify embed — Deep Focus playlist
        ...
        components.html(
            """
            <iframe
                style="border-radius:14px;border:1px solid rgba(100,160,255,0.15);"
    ...
    # ── End session button — appears after ~5s
    st.markdown("""
